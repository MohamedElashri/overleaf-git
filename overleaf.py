...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CLI tool to automate saving of Overleaf projects to a git repository.')
    ...
    if not os.path.isfile(config_path):
        logger.exception('Configuration problem: configuration file could not be parsed.')
    ...
    logger.info('Downloading overleaf project .zip file to a temporary directory...')
    try:
        temp_dir_name = 'data'
        ...
        cookie_jar = browser_cookie3.firefox(domain_name='overleaf.com')
        ...
        logger.exception('Authentication problem: please login to overleaf in your browser first.')
